...
int read_config(PrayerTimes *prayerTimes) {
    ...
    JSON_RETRIEVE_ENUM_ARRAY(prayerTimes, json, adjust_high_lats, tmp,
                             Adjusting, AdjustingMethod, "Adjusting");
    ...
    JSON_RETRIEVE_DOUBLE(prayerTimes, json, dhuhr_minutes, tmp,
                         "dhuhr_minutes");
